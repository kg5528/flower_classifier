...
def get_args():
    parser = argparse.ArgumentParser(description"Train and Save Image Classifier", usage="python ./train.py ./flowers/train --gpu --learning_rate 0.01 --hidden_units 512 --num_epochs 20", formatter_class=argparse.ArgumentDefaultHelpFormatter)
    ...
    hyper.add_argument (‘--learning_rate’, action="store", type=float, default=0.01, help=’desired learning rate, enter it’)
