...
def get_args():
    parser = argparse.ArgumentParser(description"Predict Image", usage="python ./predict.py /path/to/image.jpeg checkpoint.pth",  formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser.add_argument (‘category_names’, action="store", dest="category_name"', type=str, default="cat_to_name.json", help=’file to convert labels, enter it’)
