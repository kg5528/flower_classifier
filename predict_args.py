...
def main():
    ...
    parser.add_argument('save_name', action="store", type=str, default='/checkpoint.pth', help='file to save checkpoint, enter it')
    ...
    print(parser.parse_args(['image_path', 'checkpoint', 'save_name', 'category_names', 'top_num', 'gpu']))
